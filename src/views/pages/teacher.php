...
<head>
    ...
    <nav class="navbar navbar-dark bg-dark">
        <a class="navbar-brand" href="/" style="margin-left:20px; ">
            ...
            <b style="font-size: 200%">Modify Student Profile</b>
        </a>
    </nav>
</head>
                    ...
                    <div class="col-12 col-md-9 col-lg-7 col-xl-6">
                        <div class="card" style="border-radius: 15px;">
                            <div class="card-body p-5">
                                <h2 class="text-uppercase text-center mb-5">Edit student profile</h2>
                                ...
                                <?php 
                                        ...
                                        <input type="text" id="form3Example1cg" class="form-control form-control-lg"'; echo "value='" . $info[2] . "'" ; echo 'name="phone"/>
                                        <label class="form-label" for="form3Example1cg">Phone Number</label>
                                        <input type="email" id="form3Example3cg" class="form-control form-control-lg"'; echo "value='" . $info[1] . "'" ; echo 'name="email"/>
                                        <label class="form-label" for="form3Example3cg">Email Address </label>
                                        <input type="text" id="form3Example3cg" class="form-control form-control-lg"'; echo "value='" . $info[0] . "'" ; echo 'name="name"/>
                                        <label class="form-label" for="form3Example3cg">Name </label>
                                        <input type="text" id="form3Example3cg" class="form-control form-control-lg"'; echo "value='" . $info[3] . "'" ; echo 'name="username"/>
                                        <label class="form-label" for="form3Example3cg">Username </label>
                                        <input type="text" id="form3Example3cg" class="form-control form-control-lg"'; echo "value='" . $info[4] . "'" ; echo 'name="passwd"/>
